...
//     console.log("Upload Page Session:", session);
//   };
//   checkSession();
// }, []);
...
//     <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
//       {popupMsg && (
//         <div className={`fixed top-5 right-5 z-50 px-4 py-2 sm:px-6 sm:py-3 rounded-lg shadow-lg text-white font-medium text-sm sm:text-base ${
 ...
 const uploadImage = async (event) => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        {popupMsg && (
          <div className={`fixed top-5 right-5 z-50 px-4 py-2 sm:px-6 sm:py-3 rounded-lg shadow-lg text-white font-medium text-sm sm:text-base bg-green-500`}>
            {popupMsg}
          </div>
        )}
        <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl p-8">
